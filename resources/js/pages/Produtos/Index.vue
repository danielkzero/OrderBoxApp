      ...
      <div class="mt-4">
        <div v-if="activeProdutosTab === 'Produtos e Tabelas'">
          <div class="flex space-x-2 mb-3">
            ...
            <ButtonCustom icon="bx-import" text="Importar produtos" url="/produtos/import" :outline="true" />
          </div>
            ...
            <DataTable :columns="columns" :data="produtosNormalizados">
              <template #cell-fotos="{ row }">
                <div v-if="row?.imagens[0]">
                  <img :src="row.imagens[0].imagem_base64" class="border-2 border-white rounded-xl shadow-sm" />
                </div>
              </template>
...
const page = usePage();
const produtos = ref(page.props.produtos || []);
