<template>
  <div class="h-screen w-screen bg-gray-100 dark:bg-gray-900 grid grid-cols-[auto_1fr]">
    ...
    <aside :class="[
      ...
      @mouseenter="toogleCollapsed(false)" 
      @mouseleave="toogleCollapsed(true)">
      ...
      <!-- Navegação -->
      <nav class="px-3 py-4 space-y-2 overflow-auto">
      ...
      <div class="absolute bottom-0 left-0 right-0 border-t border-gray-200 dark:border-gray-700 px-3 py-4 space-y-2">
    ...
    <div class="h-screen overflow-hidden">
      ...
      <header class="h-16 bg-white dark:bg-gray-800 shadow flex items-center justify-between px-4">
        <!-- Hamburguer (mobile) -->
        <button @click="mobileOpen = !mobileOpen" class="lg:hidden p-2 rounded hover:bg-gray-200 dark:hover:bg-gray-700">
        ...
        <div class="flex items-center space-x-4 ms-auto me-4">
          <button class="flex items-center space-x-2 text-sm text-gray-700 dark:text-gray-200 hover:text-indigo-600 cursor-pointer hover:scale-110 transition-all">
        ...
        <div class="flex items-center space-x-4">
          ...
          <div class="relative" @click="dropdownOpen = !dropdownOpen">
            ...
            <div v-if="dropdownOpen" class="absolute right-0 mt-2 w-40 bg-white dark:bg-gray-800 rounded shadow-lg py-2 z-50">
              <Link href="/meus-dados" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700">Meus Dados</Link>
              <Link href="/logout" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700">Sair</Link>
            </div>
          </div>
        </div>
      </header>
